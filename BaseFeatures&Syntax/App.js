  ...
  render() {
    return (
      <div className="App">
        ...
        <button onClick={this.switchNameHandler.bind(this, 'Hyunju Woo')}>Switch Name</button>
        <Person 
        ...
        <Person 
          ...
          click={this.switchNameHandler.bind(this, 'Hyunju Woo!!')}> My hobbie is Reading books</Person>
        <Person 
